        ...
        <TableCell className="flex gap-3">
            <Dialog>
              <DialogTrigger asChild>
                <Button onClick={()=> editBtn(branch._id)}  className="bg-blue-600 h-8 w-8 cursor-pointer hover:bg-blue-500">
                  <Edit />
                </Button>
              </DialogTrigger>
              <UpdateBranch branchId={branchId}/>
            </Dialog>
            <Button className="bg-red-600 h-8 w-8 cursor-pointer hover:bg-red-500" onClick={()=>deleteBranch(branch._id)}>
                <Trash />
            </Button>
        </TableCell>
    </TableRow>
